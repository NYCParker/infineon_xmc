...
void CCU4_Init(void)
{
	...
	WR_REG(CCU40_CC41->PSC, CCU4_CC4_PSC_PSIV_Msk, CCU4_CC4_PSC_PSIV_Pos, CCU40_CC41_DIV_VAL);  //外部计数时，这个分频影响采样率
	...
	WR_REG(CCU40_CC41->SRS, CCU4_CC4_SRS_POSR_Msk, CCU4_CC4_SRS_POSR_Pos, 1);                   //周期匹配中断SR1
}
