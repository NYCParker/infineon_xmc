...
#define DIV_VAL	12
#define PRS_VAL	0xFFFF    //Timer = (1/120 000 000)*(2^DIV_VAL)*PRS_VAL
...
void CCU4_Init(void)
{
	...
	WR_REG(CCU40_CC40->PSC, CCU4_CC4_PSC_PSIV_Msk, CCU4_CC4_PSC_PSIV_Pos, DIV_VAL);      //分频
	WR_REG(CCU40_CC40->PRS, CCU4_CC4_PRS_PRS_Msk, CCU4_CC4_PRS_PRS_Pos, PRS_VAL);   //周期值
